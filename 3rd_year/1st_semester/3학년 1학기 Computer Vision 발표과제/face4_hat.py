...
def hat_function():
    ...
    # 이미지 불러오기
    image_hat = cv2.imread('C:/Users/Adria/hat2.png', cv2.IMREAD_UNCHANGED)
        ...
        while cap.isOpened():
            ...
            if results.detections:
                ...
                for detection in results.detections:
                    ...
                    nose_tip = (int(nose_tip.x * w) + 20, int(nose_tip.y * h) - 210)    # 이미지 내에서 실제 좌표 (x, y)

                    # image, x, y, w, h, overlay_image
                    resized_image_hat = cv2.resize(image_hat[:, :, :4], (300, 300))
